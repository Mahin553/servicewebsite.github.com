...
header menu console.log("hello");
 ...
 function headerMenu(){
  ...
  // close the manu by clicking outside of it
   ...
   menu.addEventListener("click",(event) => {
    ...
    window.innerWidth <= menuCollapseBreakpoint) {
      ...
      event.preventDefault();
       ...
       // if menu-item already expanded, collapse it and exists
      if(target.parentElement.classList.contains("active")){
         collapse();
         return;
      }

      // if menu-item already expanded.. run belw code
...
function stylerSwitcherToggle(){

   const stylerSwitcher = document.querySelector(".js-styler-switcher"),
   stylerSwitcherToggler = document.querySelector(".js-styler-switcher-toggler");

   stylerSwitcherToggler.addEventListener("click",function(){
      stylerSwitcher.classList.toggle("open");
